...
public class Cart extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Cart.this, Sign.class);
                startActivity(i);
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Intent i = new Intent(Cart.this , Item.class);
            startActivity(i);

        } else if (id == R.id.nav_account) {
            Intent i = new Intent(Cart.this , User.class);
            startActivity(i);
            ...
            Intent i = new Intent(Cart.this , Rating.class);
            startActivity(i);

        } else if (id == R.id.nav_contact) {
            Intent i = new Intent(Cart.this , Contact.class);
            startActivity(i);
